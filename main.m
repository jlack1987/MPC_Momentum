...
constants.T = 0.1;
constants.mass = 145;
constants.initialDoubleSupportDuration = 1.5;
constants.singleSupportDuration = 0.7;
constants.finalDoubleSupportDuration = 0.25;
...
% Initial centroidal momentum pivot position assuming zero initial z-com
dynamics.initialCOPx = [0,0,0];
dynamics.initialCOPy = [0,0,0];

dynamics.initialConditionY = [0;0;0;0];
dynamics.initialConditionX = [0;0;0;0];
