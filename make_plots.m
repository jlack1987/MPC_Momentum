...
c1 = get(l1,'Children');
alpha = 1;
set(c1(2),'Color',[alpha,alpha,alpha]);
...
% subplot(2,1,2);
% plot(gait.t,dynamics.z,'k','LineWidth',3);
% axis([0 4.84 0.74 0.86]);
% title('\fontsize{14}Center of Mass Height Trajectory');
% xlabel('\fontsize{14}time(s)');
